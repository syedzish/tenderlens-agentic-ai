...
function guideCopy() {
  if (state.language === "ar") {
    return {
      ...
      steps: [
        ...
        ["شغل التحليل", "يستخرج TenderLens المتمتطلبات والأدلة والمخاطر والمستندات الناقصة والخطوات التالية.", "file-check", "mint"],
        ["ناقش مع TenderLens", "ناقش التحليل الحالي بالكتابة أو الصوت بناء على سياق التقرير.", "message-circle", "teal"],
        ["صدر وراجع", "نزل ملفات PDF و DOCX و PPTX و TXT و SVG صالحة لمراجعة الفريق.", "download", "danger"],
      ],
  ...
  return {
    ...
    steps: [
      ...
      ["Run the analysis", "TenderLens extracts requirements, evidence, risks, missing documents, and next actions.", "file-check", "mint"],
      ["Discuss with TenderLens", "Discuss the active analysis by text or voice, grounded in the report context.", "message-circle", "teal"],
      ["Export and review", "Download valid PDF, DOCX, PPTX, TXT, and SVG outputs for team review.", "download", "danger"],
    ],
